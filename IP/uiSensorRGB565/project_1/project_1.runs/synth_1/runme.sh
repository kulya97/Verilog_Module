...
HD_PWD='G:/CH04_FDMA_5640/zu_prj/uisrc/03_ip/uiSensorRGB565/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uiSensorRGB565.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uiSensorRGB565.tcl
