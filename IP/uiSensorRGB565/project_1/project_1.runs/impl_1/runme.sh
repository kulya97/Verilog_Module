...
HD_PWD='G:/CH04_FDMA_5640/zu_prj/uisrc/03_ip/uiSensorRGB565/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uiSensorRGB565.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uiSensorRGB565.tcl -notrace
