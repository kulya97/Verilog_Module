...
HD_PWD='G:/ZU07A-4GB/01_soc_base_7eg/40dp_for/02_dp_vdma_test/zu_prj/uisrc/03_ip/uivideo2axism/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uivideo2axism.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uivideo2axism.tcl
